...
# student = input("please enter a name you want to check")
# if student in names:
#     print("student found")
# else:
#     print("not found")
...
# print(scores[names.index("Charlie")])
...
# students = input("please enter a students name to check")

# if students in names:
#     print(scores[names.index(students)])
# else:
#     print("not found")
...
# print(f"Top scorer(s) : {names[i]} with {max(scores)}")
...
#     if score == highest:
#         count += 1 
# print(f"{count} amount of studente got the highest")
...
#     if score < scorez:
#         count += 1
# print(f"{count} amount of students got less than 80 ")
...
# sixseven = []
# min_score = int(input("please enter a minimum range"))
# max_score = int(input("please enter a maxiumum range"))
# for i in range(len(scores)):
#     if scores[i] > min_score and scores[i] < max_score:
#         sixseven.append(names[i])
# print(sixseven)
...
students = input("please input a students name to check :")
scorez = scores[names.index(students)]
if scorez < 50:
    print("you failed")
else:
    print("you passed")
