...
# nric_numero = input("please enter your valid nric")

# if nric_numero[0].upper() in ["S", "T","F", "G"] and nric_numero[-1] == nric_numero[-1].upper() and nric_numero[1:-1].isdigit() == True:
#     print("Valid")
# else:
#     print("invalid")
...
#     else:
#         return True 
# usernamed = input("enter a username:")
# if is_valid_username(usernamed) == True:
...
'''
## Write and test your code here
# def validates_license_plates(plate):
#     if not plate[0:3].isupper():
#         return False
#     elif not plate[3:7].isdigit():
#         return False
#     elif not plate[-1].isupper():
#         return False
#     else:
#         return True 
# plates = input("please enter your vehicle plate: ")
# if validates_license_plates(plates) == True:
#     print("valid Plate,好吃")
# else:
#     print("不正确") 
...
def is_valid_postal_code(postal_code):
    if len(postal_code) != 6:
        ...
        return False
    elif not postal_code[0] in ['1','2','3','4','5','6','7']:
        return False
    else:
        return True
postale_code = input("please put in your potsdam code: ")
if is_valid_postal_code(postale_code) == True:
    print("valid postale code")
else:
    print("not valid")
